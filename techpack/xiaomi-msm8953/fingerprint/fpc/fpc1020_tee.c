...
static int select_pin_ctl(struct fpc1020_data *fpc1020, const char *name)
{
	...
	if (!fpc1020->fingerprint_pinctrl)
		return 0;
	...
	struct device_attribute *attr, const char *buf, size_t count)
{
	...
	if ((!strncmp(buf, "enable", strlen("enable")) || !strncmp(buf, "1", 1)) && fpc1020->compatible_enabled != 1) {
	...
	} else if ((!strncmp(buf, "disable", strlen("disable")) || !strncmp(buf, "0", 1)) && fpc1020->compatible_enabled != 0) {
		if (gpio_is_valid(fpc1020->irq_gpio)) {
